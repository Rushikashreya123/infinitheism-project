...
const svgNotes = `<?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
...
const PauseButton = () => {
  return <SvgXml xml={svgNotes} width="10px" height="10px"/>;
};
